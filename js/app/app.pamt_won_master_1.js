/* Source File Upload Time : 2022-04-10 11:14:28 PM*/
...
(function (_$$, $) {
    ...
    _$$.pamt_won_master_1 = {
                ...
                var _me = this,
                    _btnList = {
                        ...
                        starflag: {
								 ...
								 if (_rows.length == 0) {
									...
									/* 전체다운로드 필요하면 쓰라
                                   	$fn.confirm({msg : "전체"+$fn.getCodeMsg("문서를 엑셀다운로드 하시겠습니까?")  }).done(function(){
										...
										var _url = "/dwp/com/work/wonunit_master_1.nsf/wexceldown_all1?OpenAgent"
							...
							function _ok() {					
								$fn.cmdPost(
									$dwp.core.util.getProxyUrl('/dwp/com/work/wonunit_master_1.nsf/wcmdrefresh2?createdocument')
									,{actiontype : ('refresh_execel'), dbpath : '/dwp/com/work/wonunit_master_1.nsf' , postdata : _unids }									
									,function(data){
										...
										if ( data.hasOwnProperty("result")) {
											...
											if ( data.result == "200") {
												    ...
												    var _url = "/dwp/com/work/wonunit_master_1.nsf/wexceldown_12?OpenAgent"+ "&unid=" + data.unid;
												    $.fileDownload(_url, {
												        httpMethod: "POST"
												    });
								   ...
								   // }); //사유
									...
									/* 전체다운로드 필요하면 쓰라*/
                                   	$fn.confirm({msg : "전체"+$fn.getCodeMsg("문서를 엑셀다운로드 하시겠습니까?")  }).done(function(){
										...
										var _url = "/dwp/com/work/wonunit_master_1.nsf/wexceldown_all1?OpenAgent"+"&type=1"
									...
									,function(data){
										...
										if ( data.hasOwnProperty("result")) {
											...
											//	 console.log(data.unid) substr
												   ...
												   var _url = "/dwp/com/work/wonunit_master_1.nsf/wexceldown_12?OpenAgent"+ "&unid=" + data.unid;
                                                   $.fileDownload(_url, {httpMethod: "POST"});
                                                   // $.fileDownload('/dwp/com/work/wonunit_master_1.nsf/wexceldown_12?OpenAgent&unid=', {httpMethod : "POST", postdata : _unids});
												view.reload({page : 1});
								   ...
								   // }); //사유
									...
									/* 전체다운로드 필요하면 쓰라*/
                                   	$fn.confirm({msg : "전체"+$fn.getCodeMsg("문서를 엑셀다운로드 하시겠습니까?")  }).done(function(){
										...
										var _url = "/dwp/com/work/wonunit_master_1.nsf/wexceldown_all2?OpenAgent"
										$.fileDownload(_url, {httpMethod : "GET"});	
                        ...
                        flagupdate: {
							...
							$fn.confirm({msg : _rows.length +"개의 "+$fn.getCodeMsg("문서를 발주처리 하시겠습니까?")  }).done(function(){
								...
								$fn.cmdPost(
									...
									$dwp.core.util.getProxyUrl('/dwp/com/work/wonunit_master_1.nsf/wcmdrefresh1?createdocument')

									,{actiontype : ('refresh_bal'), dbpath : '/dwp/com/work/wonunit_master_1.nsf' , postdata : _unids }									
                          ...
                          click: function (view) {                               
                                  ...
                                  var _Dailog = $fn.dialog(null, {
                                          ...
                                          buttons: [{
                                             ...
                                             var _url = "/dwp/com/work/wonunit_master_1.nsf/wexceldown_bunki?OpenAgent"+"&sdate=" + $('[name=datepicker1]').val()+"&edate=" + $('[name=datepicker2]').val();
												    $.fileDownload(_url, {
												        httpMethod: "POST"
												    });												
                                          ...
                                          content: {
                                             url: $fn.getProxyUrl("/dwp/com/work/wonunit_master_1.nsf" + '/' + _form + '?OpenForm&un=')
                                          },
                                          open: function () {
                      ...
                      master_create: {
                        ...
                        click: function (view) {  
                            $fn.confirm({msg : $fn.getCodeMsg("마스터 문서를 생성하시겠습니까?")  }).done(function(){
                                ...
                                $fn.cmdPost(
                                    $dwp.core.util.getProxyUrl('/dwp/com/work/wonunit_master_1.nsf/wcmdrefresh1?createdocument')
                                    ,{actiontype : ('refresh_create'), dbpath : '/dwp/com/work/wonunit_master_1.nsf' , postdata : vdocname }								
                            ...
                            click: function (view) {
                                ...
                                if (_rows.length != 0) {
                                    ...
                                    var _Dailog = $fn.dialog(null, {
                                            ...
                                            buttons: [{
                                                    ...
                                                    click: function (_$dialog) {
                                                        ...
                                                        $fn.cmdPost(
                                                            ...
                                                            $dwp.core.util.getProxyUrl('/dwp/com/work/wonunit_master_1.nsf/wcmdrefresh1?createdocument'), {
                                                            actiontype: ('sendflag'),
                                                             dbpath: '/dwp/com/work/wonunit_master_1.nsf＊'+$('select[name=saupbu]').val(),
                                                            postdata: _unids,
															data1:'테스트'
                                                        }, function (data) {
                                            ...
                                            content: {
                                               url: $fn.getProxyUrl("/dwp/com/work/wonunit_master_1.nsf" + '/' + _form + '?OpenForm&un='+_unids)
                                            },
                                            open: function () {
                                                var pbtnobj = $('div.dwp-page-heading', el),
                                                btnobj = $('div.dwp-btn', pbtnobj);
						 ...
						 wviwlist11: {           //  생산 미완료
                           ...
                           // sortorder: 'ascending',
                            ...
                            category : {
                                ...
                                ,data : _$$.pamt_won_master_1._getCardCategory(_opt, "/dwp/com/work/wonunit_master_1.nsf/api/data/collections/name/wviwlist11_cate?count=500","")
						 ...
						 wviwlist11_com: {           //  생산 완료
                           ...
                           // sortorder: 'ascending',
                            ...
                            category : {
                                ...
                                //,data : _$$.resoladmin07._getRoomCategory(_opt, _opt.cdb + "/api/data/collections/name/Popview2?count=9999","")
                                //,data : _$$.resoladmin07._getRoomCategory(_opt, "/dwp/aprv/com/comm_code.nsf/api/data/collections/name/vl_card_list_common?count=999","")
                                ,data : _$$.pamt_won_master_1._getCardCategory(_opt, "/dwp/com/work/wonunit_master_1.nsf/api/data/collections/name/wviwlist11_com?count=500","")
                                ,change : function(view, select) {
                                }
                            },
                          ...
                          //  sortnm: '_finaldate',
                           // sortorder: 'ascending',
                            ...
                            category : {
                                ...
                                //,data : _$$.resoladmin07._getRoomCategory(_opt, _opt.cdb + "/api/data/collections/name/Popview2?count=9999","")
                                //,data : _$$.resoladmin07._getRoomCategory(_opt, "/dwp/aprv/com/comm_code.nsf/api/data/collections/name/vl_card_list_common?count=999","")
                                ,data : _$$.pamt_won_master_1._getCardCategory(_opt, "/dwp/com/work/wonunit_master_1.nsf/api/data/collections/name/wviwlist12?count=500","")
                                ,change : function(view, select) {
                                }
                            },
                         ...
                         //  sortnm: '_finaldate',
                          // sortorder: 'ascending',
                           ...
                           category : {
                               ...
                               //,data : _$$.resoladmin07._getRoomCategory(_opt, _opt.cdb + "/api/data/collections/name/Popview2?count=9999","")
                               //,data : _$$.resoladmin07._getRoomCategory(_opt, "/dwp/aprv/com/comm_code.nsf/api/data/collections/name/vl_card_list_common?count=999","")
                               ,data : _$$.pamt_won_master_1._getCardCategory(_opt, "/dwp/com/work/wonunit_master_1.nsf/api/data/collections/name/wviwlist12_com?count=500","")
                               ,change : function(view, select) {
                               }
                           },
                          ...
                          //  sortnm: '_finaldate',
                           // sortorder: 'ascending',
                            ...
                            category : {
                                ...
                                //,data : _$$.resoladmin07._getRoomCategory(_opt, _opt.cdb + "/api/data/collections/name/Popview2?count=9999","")
                                //,data : _$$.resoladmin07._getRoomCategory(_opt, "/dwp/aprv/com/comm_code.nsf/api/data/collections/name/vl_card_list_common?count=999","")
                                ,data : _$$.pamt_won_master_1._getCardCategory(_opt, "/dwp/com/work/wonunit_master_1.nsf/api/data/collections/name/wviwlist13?count=500","")
                                ,change : function(view, select) {
                                }
                            },
                          ...
                          //  sortnm: '_finaldate',
                           // sortorder: 'ascending',
                            ...
                            category : {
                                ...
                                //,data : _$$.resoladmin07._getRoomCategory(_opt, _opt.cdb + "/api/data/collections/name/Popview2?count=9999","")
                                //,data : _$$.resoladmin07._getRoomCategory(_opt, "/dwp/aprv/com/comm_code.nsf/api/data/collections/name/vl_card_list_common?count=999","")
                                ,data : _$$.pamt_won_master_1._getCardCategory(_opt, "/dwp/com/work/wonunit_master_1.nsf/api/data/collections/name/wviwlist13_com?count=500","")
                                ,change : function(view, select) {
                                }
                            },
                          ...
                          //  sortnm: '_finaldate',
                           // sortorder: 'ascending',
                            ...
                            category : {
                                ...
                                //,data : _$$.resoladmin07._getRoomCategory(_opt, _opt.cdb + "/api/data/collections/name/Popview2?count=9999","")
                                //,data : _$$.resoladmin07._getRoomCategory(_opt, "/dwp/aprv/com/comm_code.nsf/api/data/collections/name/vl_card_list_common?count=999","")
                                ,data : _$$.pamt_won_master_1._getCardCategory(_opt, "/dwp/com/work/wonunit_master_1.nsf/api/data/collections/name/wviwlist14?count=500","")
                                ,change : function(view, select) {
                                }
                            },
                          ...
                          //  sortnm: '_finaldate',
                           // sortorder: 'ascending',
                            ...
                            category : {
                                ...
                                //,data : _$$.resoladmin07._getRoomCategory(_opt, _opt.cdb + "/api/data/collections/name/Popview2?count=9999","")
                                //,data : _$$.resoladmin07._getRoomCategory(_opt, "/dwp/aprv/com/comm_code.nsf/api/data/collections/name/vl_card_list_common?count=999","")
                                ,data : _$$.pamt_won_master_1._getCardCategory(_opt, "/dwp/com/work/wonunit_master_1.nsf/api/data/collections/name/wviwlist14_com?count=500","")
                                ,change : function(view, select) {
                                }
                            },
                          ...
                          //  sortnm: '_finaldate',
                           // sortorder: 'ascending',
                            ...
                            category : {
                                ...
                                //,data : _$$.resoladmin07._getRoomCategory(_opt, _opt.cdb + "/api/data/collections/name/Popview2?count=9999","")
                                //,data : _$$.resoladmin07._getRoomCategory(_opt, "/dwp/aprv/com/comm_code.nsf/api/data/collections/name/vl_card_list_common?count=999","")
                                ,data : _$$.pamt_won_master_1._getCardCategory(_opt, "/dwp/com/work/wonunit_master_1.nsf/api/data/collections/name/wviwlist15?count=500","")
                                ,change : function(view, select) {
                                }
                            },
                          ...
                          //  sortnm: '_finaldate',
                           // sortorder: 'ascending',
                            ...
                            category : {
                                ...
                                //,data : _$$.resoladmin07._getRoomCategory(_opt, _opt.cdb + "/api/data/collections/name/Popview2?count=9999","")
                                //,data : _$$.resoladmin07._getRoomCategory(_opt, "/dwp/aprv/com/comm_code.nsf/api/data/collections/name/vl_card_list_common?count=999","")
                                ,data : _$$.pamt_won_master_1._getCardCategory(_opt, "/dwp/com/work/wonunit_master_1.nsf/api/data/collections/name/wviwlist15_com?count=500","")
                                ,change : function(view, select) {
                                }
                            },
                          ...
                          //  sortnm: '_finaldate',
                           // sortorder: 'ascending',
                            ...
                            category : {
                                ...
                                //,data : _$$.resoladmin07._getRoomCategory(_opt, _opt.cdb + "/api/data/collections/name/Popview2?count=9999","")
                                //,data : _$$.resoladmin07._getRoomCategory(_opt, "/dwp/aprv/com/comm_code.nsf/api/data/collections/name/vl_card_list_common?count=999","")
                                ,data : _$$.pamt_won_master_1._getCardCategory(_opt, "/dwp/com/work/wonunit_master_1.nsf/api/data/collections/name/wviwlist17?count=500","")
                                ,change : function(view, select) {
                                }
                            },
                         ...
                         //  sortnm: '_finaldate',
                          // sortorder: 'ascending',
                           ...
                           category : {
                               ...
                               //,data : _$$.resoladmin07._getRoomCategory(_opt, _opt.cdb + "/api/data/collections/name/Popview2?count=9999","")
                               //,data : _$$.resoladmin07._getRoomCategory(_opt, "/dwp/aprv/com/comm_code.nsf/api/data/collections/name/vl_card_list_common?count=999","")
                               ,data : _$$.pamt_won_master_1._getCardCategory(_opt, "/dwp/com/work/wonunit_master_1.nsf/api/data/collections/name/wviwlist17_com?count=500","")
                               ,change : function(view, select) {
                               }
                           },
                         ...
                         //  sortnm: '_finaldate',
                          // sortorder: 'ascending',
                           ...
                           category : {
                               ...
                               //,data : _$$.resoladmin07._getRoomCategory(_opt, _opt.cdb + "/api/data/collections/name/Popview2?count=9999","")
                               //,data : _$$.resoladmin07._getRoomCategory(_opt, "/dwp/aprv/com/comm_code.nsf/api/data/collections/name/vl_card_list_common?count=999","")
                               ,data : _$$.pamt_won_master_1._getCardCategory(_opt, "/dwp/com/work/wonunit_master_1.nsf/api/data/collections/name/wviwlist16?count=500","")
                               ,change : function(view, select) {
                               }
                           },
                        ...
                        //  sortnm: '_finaldate',
                         // sortorder: 'ascending',
                          ...
                          category : {
                              ...
                              //,data : _$$.resoladmin07._getRoomCategory(_opt, _opt.cdb + "/api/data/collections/name/Popview2?count=9999","")
                              //,data : _$$.resoladmin07._getRoomCategory(_opt, "/dwp/aprv/com/comm_code.nsf/api/data/collections/name/vl_card_list_common?count=999","")
                              ,data : _$$.pamt_won_master_1._getCardCategory(_opt, "/dwp/com/work/wonunit_master_1.nsf/api/data/collections/name/wviwlist16_com?count=500","")
                              ,change : function(view, select) {
                              }
                          },
                         ...
                         //  sortnm: '_finaldate',
                          // sortorder: 'ascending',
                           ...
                           category : {
                               ...
                               //,data : _$$.resoladmin07._getRoomCategory(_opt, _opt.cdb + "/api/data/collections/name/Popview2?count=9999","")
                               //,data : _$$.resoladmin07._getRoomCategory(_opt, "/dwp/aprv/com/comm_code.nsf/api/data/collections/name/vl_card_list_common?count=999","")
                               ,data : _$$.pamt_won_master_1._getCardCategory(_opt, "/dwp/com/work/wonunit_master_1.nsf/api/data/collections/name/wviwlist18?count=500","")
                               ,change : function(view, select) {
                               }
                           },
                         ...
                         //  sortnm: '_finaldate',
                          // sortorder: 'ascending',
                           ...
                           category : {
                               ...
                               //,data : _$$.resoladmin07._getRoomCategory(_opt, _opt.cdb + "/api/data/collections/name/Popview2?count=9999","")
                               //,data : _$$.resoladmin07._getRoomCategory(_opt, "/dwp/aprv/com/comm_code.nsf/api/data/collections/name/vl_card_list_common?count=999","")
                               ,data : _$$.pamt_won_master_1._getCardCategory(_opt, "/dwp/com/work/wonunit_master_1.nsf/api/data/collections/name/wviwlist18_com?count=500","")
                               ,change : function(view, select) {
                               }
                           },
        ...
        _getCardCategory : function(opt, url, cate) {
			...
			console.log(_url);
			console.log(cate);
	        $fn.xAjax(_$$.pamt_won_master_1._jsonGetParmDataUrl(_url, cate))
