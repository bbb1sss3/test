 ...
 (function (_$$, $) {
    _$$.aprv_sub009 = {
        subdoc: {
            SUBNAME: "sub009"
            , init: function ($doc) {
                var _me = _$$.aprv_sub009.subdoc, opt = $doc.options;
                var el = $doc.element;
                var _$table01 = $("table[name=sub009_Table01]", $doc.element);
            ...
            , initInputTable: function (_opt, $doc) {
                ...
                var _$table = $dwp.ui.table.init($("table[name='" + _me.SUBNAME + "_Table01']", $doc.element), {
                    ...
                    , cell: [
                        {
                            nm: "no", type: "custom", vfnm: "_NO", validator: /[^\s]/, label: "aprv_sub_009.title.a1"
                        ...
                        {
                            nm: "day", type: "date", vfnm: "_DAY", css: "dwp-center",  label: "aprv_sub_009.title.a2"
                            , drawfn: function (val, $cell, $tr, inst) {
                                if (inst.options.isedit) {
                        ...
                        {
                            nm: "go", type: "custom", vfnm: "_GO",  label: "aprv_sub_009.title.a3"
                            , drawfn: function (val, $cell, $tr, inst) {
                                if (inst.options.isedit) {
                        ...
                        {
                            nm: "stopover", type: "custom", vfnm: "_STOPOVER",  label: "aprv_sub_009.title.a4"
                            , drawfn: function (val, $cell, $tr, inst) {
                                if (inst.options.isedit) {
                        ...
                        {
                            nm: "destination", type: "custom", vfnm: "_DESTINATION",  label: "aprv_sub_009.title.a6"
                            , drawfn: function (val, $cell, $tr, inst) {
                                if (inst.options.isedit) {
                        ...
                        {
                            nm: "distance", type: "custom", vfnm: "_DISTANCE", validator: /[^\s]/, label: "aprv_sub_009.title.a5"
                            , drawfn: function (val, $cell, $tr, inst) {
                                if (inst.options.isedit) {
									//_BUN2*_BUN6= _BUN7 
                        ...
                        {
                            nm: "bigo", type: "custom", vfnm: "_BIGO",  label: "aprv_sub_009.title.a6"
                            , drawfn: function (val, $cell, $tr, inst) {
                                if (inst.options.isedit) {
            ...
            , save: function ($doc, opt) {
                ...
                var _$table = $("table[name=" + _me.SUBNAME + "_Table01]", $doc.element).xtable("instance");
                    ...
                    if ($("input[name='CarNo']",$doc.element).val() == "") {
                            ...
                            //  차량no 입력하세요.
                            $fn.alert({msg : $fn.getCodeMsg("aprv_sub_009.msg.a1")});    //사유
                        
                        return false;
                    }else if($("input[name='OrgPreDate']",$doc.element).val() == "" || $("input[name='OrgPostDate']",el).val() == ""){
                            //  운행기간 입력하세요.
                            $fn.alert({msg : $fn.getCodeMsg("aprv_sub_009.msg.a2")});    //사유
               ...
               if($('[name=ed_attachkind] option:selected',$doc.element).val() == "A" || $('[name=ed_attachkind] option:selected',$doc.element).val() == "B"){
                    if($("input[name='PL_1']",$doc.element).val() == "0" ){
                        ...
                        $fn.alert({msg : $fn.getCodeMsg("aprv_sub_009.msg.a3")});    //사유
                ...
                //     return false;
                // }
                // if (!$fn.validate($("table[name='subform009_body']"))) {
                //     _isvalid = false;
                //     return false;
                // }
