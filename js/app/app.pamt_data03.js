/* Source File Upload Time : 2022-04-03 9:24:03 PM*/
		...
		view: {
			...
			_headerInfo: function (_opt) {
				...
				_col = {
					...
					location: {
						name: '_location',
						title: $fn.getCodeMsg('pamt_data03.title.header1'),    //사업장
						width: '5%',
						//click : function(view,o, ele){
						//	_$$.pamt_data03.view._readForm(view,o["@unid"], ele,_opt);
						//},	
						sort: false
					},
					kind: {
						name: '_kind',
						title: $fn.getCodeMsg('pamt_data03.title.h2'),    //구분
						width: '5%',
						sort: false
					},
					code: {
						name: '_code',
						title: $fn.getCodeMsg('pamt_data03.title.h3'),    //업체코드
						width: '3%',
						sort: false
					},
					companyproto: {
						name: '_companyproto',
						title: $fn.getCodeMsg('pamt_data03.title.h4'),	//업체구분명
						width: '5%',
						sort: false
					},
					servone: {
						name: '_servone',
						title: $fn.getCodeMsg('pamt_data03.title.h5'),	//서브원등록여부
						width: '2%',
						sort: false
					},
					usernum: {
						name: '_usernum',
						title: $fn.getCodeMsg('pamt_data03.title.h13'),	//사업자등록번호
						width: '10%',
						sort: false
					},
					value: {
						name: '_value',
						title: $fn.getCodeMsg('pamt_data03.title.h6'),	//업체명
						width: '15%',
						sort: false
					},
					commaster: {
						name: '_commaster',
						title: $fn.getCodeMsg('pamt_data03.title.h7'),	//대표이사
						width: '3%',
						sort: false
					},
					telmaster: {
						name: '_telmaster',
						title: $fn.getCodeMsg('pamt_data03.title.h8'),	//대표이사 전화번호
						width: '3%',
						sort: false
					},
					commanager: {
						name: '_commanager',
						title: $fn.getCodeMsg('pamt_data03.title.h9'),	//담당자
						width: '3%',
						sort: false
					},
					telmanager: {
						name: '_telmanager',
						title: $fn.getCodeMsg('pamt_data03.title.h10'),	//담당자 전화번호
						width: '3%',
						sort: false
					},
					mailaddress: {
						name: '_mailaddress',
						title: $fn.getCodeMsg('pamt_data03.title.h11'),	//담당자 전화번호
						width: '3%',
						sort: false
					},				
					sendtoname: {
						name: '_sendtoname',
						title: $fn.getCodeMsg('pamt_data03.title.header2'),	//담당자 전화번호
						width: 'auto',
						sort: false
					},	
					// 아래 필드는 미사용
					authorname: {
						name: '_authorname',
						title: $fn.getCodeMsg('pamt_data03.title.h9'),	//담당
						width: '9%',
						sort: false,
						type: 'fnc',
						content: function (o) {
