 ...
 (function (_$$, $) {
    _$$.aprv_sub190 = {
        subdoc: {
            SUBNAME: "sub190"
            , init: function ($doc) {
                var _me = _$$.aprv_sub190.subdoc, opt = $doc.options;
                var el = $doc.element;
                var _$table01 = $("table[name=sub190_Table01]", $doc.element);
            ...
            , save: function ($doc, opt) {
                ...
                var _aopt = $.extend({ actiontype: "" }, opt);
                    ...
                    if ($("[name='Con']",$doc.element).val() == "") {
                            ...
                            //  발주번호를 입력하세요.
                            $fn.alert({msg : $fn.getCodeMsg("aprv_sub_190.msg.a1")});    //사유
