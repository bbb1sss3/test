/* Source File Upload Time : 2022-04-14 10:21:51 PM*/
...
(function (_$$, $) {
    ...
    _$$.pamt_won_master = {
                                            ...
                                            buttons: [{
                                                    ...
                                                    click: function (_$dialog) {
                                                        ...
                                                        $fn.cmdPost(
                                                            ...
                                                            ,{actiontype : ('refresh_create'), dbpath : '/dwp/com/work/wonunit_master.nsf' , postdata : vdocname , 
                                                            postdata_1 : $('select[name=saupbu]').val() }								
                                                            ...
                                                            ,function(data){
                                                                ...
                                                                $fn.toast({msg : $fn.getCodeMsg(data.comcode+" 마스터문서가 생성 되었습니다.") });
                            ...
                            click: function (view) {
                                ...
                                if (_rows.length != 0) {
                                    ...
                                    var _Dailog = $fn.dialog(null, {
                                            ...
                                            buttons: [{
                                                    ...
                                                    click: function (_$dialog) {
                                                        ...
                                                        $fn.cmdPost(
                                                            ...
                                                            $dwp.core.util.getProxyUrl('/dwp/com/work/wonunit_master.nsf/wcmdrefresh1?createdocument'), {
                                                            actiontype: ('sendflag'),
                                                             dbpath: '/dwp/com/work/wonunit_master.nsf＊'+$('select[name=saupbu]').val(),
                                                            postdata: _unids,
															data1:'테스트'
                                                        }, function (data) {
                                            ...
                                            content: {
                                               url: $fn.getProxyUrl("/dwp/com/work/wonunit_master.nsf" + '/' + _form + '?OpenForm&un='+_unids)
                                            },
                                            open: function () {
                                                var pbtnobj = $('div.dwp-page-heading', el),
                                                btnobj = $('div.dwp-btn', pbtnobj);
						 ...
						 wviwlist11: {           //  생산 미완료
                           ...
                           // sortorder: 'ascending',
                            ...
                            category : {
                                ...
                                ,data : _$$.pamt_won_master._getCardCategory(_opt, "/dwp/com/work/wonunit_master.nsf/api/data/collections/name/wviwlist11_cate?count=500","")
						 ...
						 wviwlist11_com: {           //  생산 완료
                           ...
                           // sortorder: 'ascending',
                            ...
                            category : {
                                ...
                                //,data : _$$.resoladmin07._getRoomCategory(_opt, _opt.cdb + "/api/data/collections/name/Popview2?count=9999","")
                                //,data : _$$.resoladmin07._getRoomCategory(_opt, "/dwp/aprv/com/comm_code.nsf/api/data/collections/name/vl_card_list_common?count=999","")
                                ,data : _$$.pamt_won_master._getCardCategory(_opt, "/dwp/com/work/wonunit_master.nsf/api/data/collections/name/wviwlist11_com?count=500","")
                                ,change : function(view, select) {
                                }
                            },
                          ...
                          //  sortnm: '_finaldate',
                           // sortorder: 'ascending',
                            ...
                            category : {
                                ...
                                //,data : _$$.resoladmin07._getRoomCategory(_opt, _opt.cdb + "/api/data/collections/name/Popview2?count=9999","")
                                //,data : _$$.resoladmin07._getRoomCategory(_opt, "/dwp/aprv/com/comm_code.nsf/api/data/collections/name/vl_card_list_common?count=999","")
                                ,data : _$$.pamt_won_master._getCardCategory(_opt, "/dwp/com/work/wonunit_master.nsf/api/data/collections/name/wviwlist12?count=500","")
                                ,change : function(view, select) {
                                }
                            },
                         ...
                         //  sortnm: '_finaldate',
                          // sortorder: 'ascending',
                           ...
                           category : {
                               ...
                               //,data : _$$.resoladmin07._getRoomCategory(_opt, _opt.cdb + "/api/data/collections/name/Popview2?count=9999","")
                               //,data : _$$.resoladmin07._getRoomCategory(_opt, "/dwp/aprv/com/comm_code.nsf/api/data/collections/name/vl_card_list_common?count=999","")
                               ,data : _$$.pamt_won_master._getCardCategory(_opt, "/dwp/com/work/wonunit_master.nsf/api/data/collections/name/wviwlist12_com?count=500","")
                               ,change : function(view, select) {
                               }
                           },
                          ...
                          //  sortnm: '_finaldate',
                           // sortorder: 'ascending',
                            ...
                            category : {
                                ...
                                //,data : _$$.resoladmin07._getRoomCategory(_opt, _opt.cdb + "/api/data/collections/name/Popview2?count=9999","")
                                //,data : _$$.resoladmin07._getRoomCategory(_opt, "/dwp/aprv/com/comm_code.nsf/api/data/collections/name/vl_card_list_common?count=999","")
                                ,data : _$$.pamt_won_master._getCardCategory(_opt, "/dwp/com/work/wonunit_master.nsf/api/data/collections/name/wviwlist13?count=500","")
                                ,change : function(view, select) {
                                }
                            },
                          ...
                          //  sortnm: '_finaldate',
                           // sortorder: 'ascending',
                            ...
                            category : {
                                ...
                                //,data : _$$.resoladmin07._getRoomCategory(_opt, _opt.cdb + "/api/data/collections/name/Popview2?count=9999","")
                                //,data : _$$.resoladmin07._getRoomCategory(_opt, "/dwp/aprv/com/comm_code.nsf/api/data/collections/name/vl_card_list_common?count=999","")
                                ,data : _$$.pamt_won_master._getCardCategory(_opt, "/dwp/com/work/wonunit_master.nsf/api/data/collections/name/wviwlist13_com?count=500","")
                                ,change : function(view, select) {
                                }
                            },
                          ...
                          //  sortnm: '_finaldate',
                           // sortorder: 'ascending',
                            ...
                            category : {
                                ...
                                //,data : _$$.resoladmin07._getRoomCategory(_opt, _opt.cdb + "/api/data/collections/name/Popview2?count=9999","")
                                //,data : _$$.resoladmin07._getRoomCategory(_opt, "/dwp/aprv/com/comm_code.nsf/api/data/collections/name/vl_card_list_common?count=999","")
                                ,data : _$$.pamt_won_master._getCardCategory(_opt, "/dwp/com/work/wonunit_master.nsf/api/data/collections/name/wviwlist14?count=500","")
                                ,change : function(view, select) {
                                }
                            },
                          ...
                          //  sortnm: '_finaldate',
                           // sortorder: 'ascending',
                            ...
                            category : {
                                ...
                                //,data : _$$.resoladmin07._getRoomCategory(_opt, _opt.cdb + "/api/data/collections/name/Popview2?count=9999","")
                                //,data : _$$.resoladmin07._getRoomCategory(_opt, "/dwp/aprv/com/comm_code.nsf/api/data/collections/name/vl_card_list_common?count=999","")
                                ,data : _$$.pamt_won_master._getCardCategory(_opt, "/dwp/com/work/wonunit_master.nsf/api/data/collections/name/wviwlist14_com?count=500","")
                                ,change : function(view, select) {
                                }
                            },
                          ...
                          //  sortnm: '_finaldate',
                           // sortorder: 'ascending',
                            ...
                            category : {
                                ...
                                //,data : _$$.resoladmin07._getRoomCategory(_opt, _opt.cdb + "/api/data/collections/name/Popview2?count=9999","")
                                //,data : _$$.resoladmin07._getRoomCategory(_opt, "/dwp/aprv/com/comm_code.nsf/api/data/collections/name/vl_card_list_common?count=999","")
                                ,data : _$$.pamt_won_master._getCardCategory(_opt, "/dwp/com/work/wonunit_master.nsf/api/data/collections/name/wviwlist15?count=500","")
                                ,change : function(view, select) {
                                }
                            },
                          ...
                          //  sortnm: '_finaldate',
                           // sortorder: 'ascending',
                            ...
                            category : {
                                ...
                                //,data : _$$.resoladmin07._getRoomCategory(_opt, _opt.cdb + "/api/data/collections/name/Popview2?count=9999","")
                                //,data : _$$.resoladmin07._getRoomCategory(_opt, "/dwp/aprv/com/comm_code.nsf/api/data/collections/name/vl_card_list_common?count=999","")
                                ,data : _$$.pamt_won_master._getCardCategory(_opt, "/dwp/com/work/wonunit_master.nsf/api/data/collections/name/wviwlist15_com?count=500","")
                                ,change : function(view, select) {
                                }
                            },
                          ...
                          //  sortnm: '_finaldate',
                           // sortorder: 'ascending',
                            ...
                            category : {
                                ...
                                //,data : _$$.resoladmin07._getRoomCategory(_opt, _opt.cdb + "/api/data/collections/name/Popview2?count=9999","")
                                //,data : _$$.resoladmin07._getRoomCategory(_opt, "/dwp/aprv/com/comm_code.nsf/api/data/collections/name/vl_card_list_common?count=999","")
                                ,data : _$$.pamt_won_master._getCardCategory(_opt, "/dwp/com/work/wonunit_master.nsf/api/data/collections/name/wviwlist17?count=500","")
                                ,change : function(view, select) {
                                }
                            },
                         ...
                         //  sortnm: '_finaldate',
                          // sortorder: 'ascending',
                           ...
                           category : {
                               ...
                               //,data : _$$.resoladmin07._getRoomCategory(_opt, _opt.cdb + "/api/data/collections/name/Popview2?count=9999","")
                               //,data : _$$.resoladmin07._getRoomCategory(_opt, "/dwp/aprv/com/comm_code.nsf/api/data/collections/name/vl_card_list_common?count=999","")
                               ,data : _$$.pamt_won_master._getCardCategory(_opt, "/dwp/com/work/wonunit_master.nsf/api/data/collections/name/wviwlist17_com?count=500","")
                               ,change : function(view, select) {
                               }
                           },
                         ...
                         //  sortnm: '_finaldate',
                          // sortorder: 'ascending',
                           ...
                           category : {
                               ...
                               //,data : _$$.resoladmin07._getRoomCategory(_opt, _opt.cdb + "/api/data/collections/name/Popview2?count=9999","")
                               //,data : _$$.resoladmin07._getRoomCategory(_opt, "/dwp/aprv/com/comm_code.nsf/api/data/collections/name/vl_card_list_common?count=999","")
                               ,data : _$$.pamt_won_master._getCardCategory(_opt, "/dwp/com/work/wonunit_master.nsf/api/data/collections/name/wviwlist16?count=500","")
                               ,change : function(view, select) {
                               }
                           },
                        ...
                        //  sortnm: '_finaldate',
                         // sortorder: 'ascending',
                          ...
                          category : {
                              ...
                              //,data : _$$.resoladmin07._getRoomCategory(_opt, _opt.cdb + "/api/data/collections/name/Popview2?count=9999","")
                              //,data : _$$.resoladmin07._getRoomCategory(_opt, "/dwp/aprv/com/comm_code.nsf/api/data/collections/name/vl_card_list_common?count=999","")
                              ,data : _$$.pamt_won_master._getCardCategory(_opt, "/dwp/com/work/wonunit_master.nsf/api/data/collections/name/wviwlist16_com?count=500","")
                              ,change : function(view, select) {
                              }
                          },
                         ...
                         //  sortnm: '_finaldate',
                          // sortorder: 'ascending',
                           ...
                           category : {
                               ...
                               //,data : _$$.resoladmin07._getRoomCategory(_opt, _opt.cdb + "/api/data/collections/name/Popview2?count=9999","")
                               //,data : _$$.resoladmin07._getRoomCategory(_opt, "/dwp/aprv/com/comm_code.nsf/api/data/collections/name/vl_card_list_common?count=999","")
                               ,data : _$$.pamt_won_master._getCardCategory(_opt, "/dwp/com/work/wonunit_master.nsf/api/data/collections/name/wviwlist18?count=500","")
                               ,change : function(view, select) {
                               }
                           },
                         ...
                         //  sortnm: '_finaldate',
                          // sortorder: 'ascending',
                           ...
                           category : {
                               ...
                               //,data : _$$.resoladmin07._getRoomCategory(_opt, _opt.cdb + "/api/data/collections/name/Popview2?count=9999","")
                               //,data : _$$.resoladmin07._getRoomCategory(_opt, "/dwp/aprv/com/comm_code.nsf/api/data/collections/name/vl_card_list_common?count=999","")
                               ,data : _$$.pamt_won_master._getCardCategory(_opt, "/dwp/com/work/wonunit_master.nsf/api/data/collections/name/wviwlist18_com?count=500","")
                               ,change : function(view, select) {
                               }
                           },
        ...
        _getCardCategory : function(opt, url, cate) {
			...
			console.log(_url);
			console.log(cate);
	        $fn.xAjax(_$$.pamt_won_master._jsonGetParmDataUrl(_url, cate))
