/* Source File Upload Time : 2022-10-17 10:42:55 AM*/


/* Source File Upload Time : 2020-12-03 3:41:32 PM*/


/* Source File Upload Time : 2020-07-14 2:05:39 AM*/


/* Source File Upload Time : 6-30-20 10:09:05 AM*/


/* Source File Upload Time : 2020-06-05 10:23:25 PM*/


/* Source File Upload Time : 2019-10-19 8:06:43 PM*/
...
(function(_$$, $){
	_$$.aprv_sub230 = {
		subdoc : {
			SUBNAME	: "sub230"	, 
			init : function($doc) {
				var _me = _$$.aprv_sub230.subdoc, opt = $doc.options;
				var el = $doc.element;
				...
				//var _$table01 = $("table[name=sub230_Table01]", $doc.element);
				//새문서일 경우
				if (opt.isnew) {
				...
				/*
				$("input[name='A05_KRW']").on("keyup", function () {
					$(this).val($(this).val().replace(/[^0-9]/g, ""));
				});
				$("input[name='A06_KRW']").on("keyup", function () {
					$(this).val($(this).val().replace(/[^0-9]/g, ""));
				});
				*/
				//alert("@@")
				...
				$("input[name='A01']:radio").click(function () {
					//선택하지 못하도록 알람 발생
					$fn.alert({msg : $fn.getCodeMsg("aprv_sub_230.msg.error01")});
				...
				_$sel_obj0.bind("change" , function(){
					...
					if ( $("input[name='AppMRate']" , $doc.element).val() == "" )  {
					...
					if ( _$v0 == "" ) {
						...
						$fn.alert({msg : $fn.getCodeMsg("aprv_sub_230.msg.error04")});						
						return;
					...
					if ( _$v1 == "" ) {
						$("select[name='ed_gubun']", $doc.element).xval("");
						$("input[name='ed_oil_sum']", $doc.element).xval("0");
						$fn.alert({msg : $fn.getCodeMsg("aprv_sub_230.msg.error05")});
						return;
					}
					if ( _$v2 == "" ) {
						$("select[name='ed_gubun']", $doc.element).xval("");
				...
				$("#_pop1").on("click", function () {
					...
					if (_info.cuser.lang == "ko") {
								var vurl= "/dwp/aprv/com/comm_code.nsf/TripRulePage?OpenPage" 
						}else{
								var vurl= "/dwp/aprv/com/comm_code.nsf/TripRulePage_jp?OpenPage" 
					...
					var _rptDailog = $fn.dialog(null, {
						...
						islangconvert: false,
						referdata: el,
						title: $fn.getCodeMsg("aprv_sub_230.btn.a0"),
						width: 650,
						height: 800,
						show: 'fade', //effect
						hide: 'fade', //effect
						langpath: $fn.getPath("weblib") + "/lang/" + $fn.getCurUser().lang + "/aprv_sub_230.lang.js",
						content: {
							html: "",
				...
				$("#_pop2").on("click", function () {
					var _form = "wMeetingView";
						var _rptDailog = $fn.dialog(null, {
							...
							islangconvert: false,
							referdata: el,
							title: $fn.getCodeMsg("aprv_sub_230.title.a19"),
							width: 1100,
							height: 800,
							show: 'fade', //effect
							hide: 'fade', //effect
							...
							buttons: [
								{
									...
									click: function (_$dialog) {
										...
										//필드 보내기
										_addLine(sum_count ,"sub230_Table01");
										//_addLinedummy(sum_count ,"sub230_Table01");
							...
							buttons: [
								{
									...
									click: function (_$dialog) {
										...
										//필드 보내기
										_addLine1(sum_count ,"sub230_Table02");
										//_addLinedummy(sum_count ,"sub230_Table01");
				...
				//일비 및 식비 게산 출장정산서 교육 ( 일비 없음 식비도 조건에 따라서 수정)
				$("#_pop4").on("click", function () {
					$fn.confirm({ msg: $fn.getCodeMsg("aprv_sub_230.title.a38") }).done(function () {
						...
						if ( typeof $(":input:radio[name=A01]:checked").val() == 'undefined' ) {
							$fn.alert({ msg: $fn.getCodeMsg("aprv_sub_230.msg.error") });
							return;
						}
							...
							if (data.hasOwnProperty('result')) {                                            
								if (data.result >= '200' && data.result < '300') {
									...
									*/
									...
									$("input[name='A05_KRW']").val(_day_krw);
									*/
									$("input[name='A05_KRW']").val("0");

									// 하단 총합계 란에 적용
									$("input[name='ed_total_all_1']").val("0");
                ...
                $("#_pop10").on("click", function () {
					...
					var _rptDailog = $fn.dialog(null,{
						...
						islangconvert: false,
						referdata: _opt,
						title: $fn.getCodeMsg("aprv_sub_230.title.a40"),                                            
						width: 1200,
						height: 640,
						show: 'fade',			//effect
						hide: 'fade',			//effect
                ...
                $("#_pop20").on("click", function () {
					...
					var _rptDailog = $fn.dialog(null,{
						...
						islangconvert: false,
						referdata: _opt,
						title: $fn.getCodeMsg("aprv_sub_230.title.a41"),                                            
						width: 800,
						height: 640,
						show: 'fade',			//effect
						hide: 'fade',			//effect
                ...
                $("#_pop30").on("click", function () {
					...
					var _rptDailog = $fn.dialog(null,{
						...
						islangconvert: false,
						referdata: _opt,
						title: $fn.getCodeMsg("aprv_sub_230.title.a42"),                                            
						width: 1200,
						height: 640,
						show: 'fade',			//effect
						hide: 'fade',			//effect
				...
				function _addItem(_MERC_NAME,money_val,unid,sum_count,gl,address,userbank,userbanknum,date_val) {
					...
					*/
					...
					var _me = _$$.aprv_sub230.subdoc;				
					var _$input_tbl = $("table[name=sub230_Table01]", el);
					var _$input_trs = $("tr", _$input_tbl);
				...
				function _addItem1(_MERC_NAME,money_val,unid,sum_count,gl,address,userbank,userbanknum , date_val) {
					...
					*/
					...
					var _me = _$$.aprv_sub230.subdoc;				
					var _$input_tbl = $("table[name=sub230_Table02]", el);
					var _$input_trs = $("tr", _$input_tbl);
            ...
            , initInputTable: function (_opt, $doc) {
                ...
                var _$table = $dwp.ui.table.init($("table[name='" + "sub230" + "_Table01']", $doc.element), {
                    isedit: _opt.isedit
                    , initdata: _tableVal
                    ...
                    , cell: [
                        {
                            nm: "hgbn01", type: "custom", vfnm: "gbn01", validator: /[^\s]/, label: "aprv_sub_230.title.a15"
                        ...
                        {
                            nm: "hcost01", type: "custom", vfnm: "cost01", css: "dwp-right", validator: /[^\s]/, label: "aprv_sub_230.title.a16"
                            , drawfn: function (val, $cell, $tr, inst) {
                                if (inst.options.isedit) {
                        ...
                        {
                            nm: "hinfo01", type: "custom", vfnm: "info01", validator: /[^\s]/, label: "aprv_sub_230.title.a17"
                            , drawfn: function (val, $cell, $tr, inst) {
                                if (inst.options.isedit) {
            ...
            , initInputTable01: function (_opt, $doc) {
                ...
                var _$table1 = $dwp.ui.table.init($("table[name='" + "sub230" + "_Table02']", $doc.element), {
                    isedit: _opt.isedit
                    , initdata: _tableVal
                    , template: "[name=_template]"
                    , keyfield: ["cost02"]
                    ...
                    , cell: [
                        {
                            nm: "hgbn02", type: "custom", vfnm: "gbn02", validator: /[^\s]/, label: "aprv_sub_230.title.a15"
                            , drawfn: function (val, $cell, $tr, inst) {
                                if (inst.options.isedit) {
                        ...
                        {
                            nm: "hcost02", type: "custom", vfnm: "cost02", css: "dwp-right", validator: /[^\s]/, label: "aprv_sub_230.title.a16"
                            , drawfn: function (val, $cell, $tr, inst) {
                                if (inst.options.isedit) {
                                    //var _$type = $("input[name='_AMOUNT']", $cell);
                                    //_$type.xval(val);
                        ...
                        {
                            nm: "hdesc", type: "custom", vfnm: "edesc", validator: /[^\s]/, label: "aprv_sub_230.title.a17"
                            , drawfn: function (val, $cell, $tr, inst) {
                                if (inst.options.isedit) {
            ...
            , initInputTable03: function (_opt, $doc) {
                ...
                var _$table3 = $dwp.ui.table.init($("table[name='" + "sub230" + "_Table03']", $doc.element), {
                    isedit: _opt.isedit
                    , initdata: _tableVal
                    , template: "[name=_template]"
                    , keyfield: ["hstart3"]
                    ...
                    , cell: [
                        {
                            nm: "hgbn03", type: "custom", vfnm: "gbn03", validator: /[^\s]/, label: "aprv_sub_230.title.a15"
                            , drawfn: function (val, $cell, $tr, inst) {
                                if (inst.options.isedit) {
                        ...
                        {
                            nm: "hstart3", type: "custom", vfnm: "start3", validator: /[^\s]/, label: "aprv_sub_230.title.a30"
                            , drawfn: function (val, $cell, $tr, inst) {
                                if (inst.options.isedit) {
                        ...
                        {
                            nm: "hend3", type: "custom", vfnm: "end3", validator: /[^\s]/, label: "aprv_sub_230.title.a31"
                            , drawfn: function (val, $cell, $tr, inst) {
                                if (inst.options.isedit) {
						...
						{
                            nm: "hcost031", type: "custom", vfnm: "cost031", css: "dwp-right", validator: /[^\s]/, label: "aprv_sub_230.title.a32"
                            , drawfn: function (val, $cell, $tr, inst) {
                                if (inst.options.isedit) {
                                    //var _$type = $("input[name='_AMOUNT']", $cell);
									//_$type.xval(val);
									...
									_$input.on("blur", function () {
										...
										if (_rate == "" ) {
											$fn.alert({
												msg: $fn.getCodeMsg("aprv_sub_230.msg.error06")
											}); //일당 및 외화 정보 누락
											_$input.xval("0");											
											return false;
										}
                        ...
                        {
                            nm: "hcost032", type: "custom", vfnm: "cost032", css: "dwp-right", validator: /[^\s]/, label: "aprv_sub_230.title.a16"
                            , drawfn: function (val, $cell, $tr, inst) {
                                if (inst.options.isedit) {
                                    //var _$type = $("input[name='_AMOUNT']", $cell);
                                    //_$type.xval(val);
						...
						{
							nm: "hpdate3", type: "date", vfnm: "_PDATE", css: "dwp-center", validator: /[^\s]/, label: "aprv_sub_230.title.a57"
							, drawfn: function (val, $cell, $tr, inst) {
								if (inst.options.isedit) {
            ...
            , initInputTable04: function (_opt, $doc) {
                ...
                var _$table4 = $dwp.ui.table.init($("table[name='" + "sub230" + "_Table04']", $doc.element), {
                    isedit: _opt.isedit
                    , initdata: _tableVal
                    , template: "[name=_template]"
                    , keyfield: ["cost042"]
                    ...
                    , cell: [
                        {
                            nm: "hgbn04", type: "custom", vfnm: "gbn04", validator: /[^\s]/, label: "aprv_sub_230.title.a15"
                            , drawfn: function (val, $cell, $tr, inst) {
                                if (inst.options.isedit) {
						...
						{
                            nm: "hcost041", type: "custom", vfnm: "cost041", css: "dwp-right", validator: /[^\s]/, label: "aprv_sub_230.title.a32"
                            , drawfn: function (val, $cell, $tr, inst) {
                                if (inst.options.isedit) {
                                    //var _$type = $("input[name='_AMOUNT']", $cell);
									//_$type.xval(val);
                        ...
                        {
                            nm: "hcost042", type: "custom", vfnm: "cost042", css: "dwp-right", validator: /[^\s]/, label: "aprv_sub_230.title.a16"
                            , drawfn: function (val, $cell, $tr, inst) {
                                if (inst.options.isedit) {
                                    //var _$type = $("input[name='_AMOUNT']", $cell);
                                    //_$type.xval(val);
						...
						{
                            nm: "hdesc4", type: "custom", vfnm: "desc4", validator: /[^\s]/, label: "aprv_sub_230.title.a34"
                            , drawfn: function (val, $cell, $tr, inst) {
                                if (inst.options.isedit) {
            ...
            , cal_sum3: function (el , tr) {                                
                var _me = _$$.aprv_sub230.subdoc;
				//alert( _me.SUBNAME)
                var _$input_tbl = $("table[name=sub230_Table03]", el);
            ...
            , cal_sum4: function (el , tr) {                                
                var _me = _$$.aprv_sub230.subdoc;
				//alert( _me.SUBNAME)
                var _$input_tbl = $("table[name=sub230_Table04]", el);
			...
			, save : function($doc,opt){
				...
				|| $("input[name=chk_5]").val() ==""
					  ...
					  $fn.alert({msg : $fn.getCodeMsg("aprv_sub_230.title.a77")});   //촬영일시 
         				return false;
				...
				if(  $("select[name='A08']", $doc.element).find("option:selected").xval() != "0" ) {
					if ($("input[name='A09']", el).xval() == "") {
						$fn.alert({
							msg: $fn.getCodeMsg("aprv_sub_230.msg.error07")
						}); //식비 차감 사유를 입력하세요.
						return false;
					}						
				}
				...
				if ($("input[name='dcode']", el).xval() == "") {
					$fn.alert({
						msg: $fn.getCodeMsg("aprv_sub_230.msg.error02")
					}); //부서정보 필수 입력
					return false;
				}
				if ($("input[name='acccode']", el).xval() == "") {
					$fn.alert({
						msg: $fn.getCodeMsg("aprv_sub_230.msg.error03")
					}); //계정정보 필수 입력
					return false;
				}
				...
				if (_aopt.actiontype == "raise") {					
					if ($("input[name='ed_total_proc1']", el).xval() != "0") {
						if ( $("input[name='GL1']", el).xval() == "" || $("input[name='ADDRESS1']", el).xval() == "" ) {
							$fn.alert({
								msg: $fn.getCodeMsg("aprv_sub_230.title.a78")
							}); //계정정보 필수 입력
							return false;
						}
					}
