		...
		, view: {
			...
			, _headerInfo: function (_opt) {
				...
				var _searchcate = [{ title: $fn.getCodeMsg("sbrd01.title.searchall"), key: "all" }
					, { title: $fn.getCodeMsg("년도+분기"), key: "YEARBUNKI" }				
				...
				var _hList = {
					...
					, wvnotice: {
						...
						, isreply: false					
						, colnm: ['created','created1','author', 'subject' ]
						, search: [{ title: $fn.getCodeMsg("sbrd01.title.searchall"), key: "all" }
						, { title: $fn.getCodeMsg("년도+분기"), key: "YEARBUNKI" }				
						, { title: $fn.getCodeMsg("sbrd01.title.searchsubject"), key: "Subject" }
						]
						//,click : function(){}
					...
					, wvrecent: {
						...
						, isreply: true
						, category: _cate
						, colnm: ['created', 'boardname', 'attach', 'subject', 'author', 'orgname']
						, search: _searchcate
						//,click : function(){}
					}
					, wvrecent1: {
