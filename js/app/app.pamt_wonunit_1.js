    ...
    _$$.pamt_wonunit_1 = {
        ...
        doc: {
            ...
            init: function (opt) {
				...
				$("#_jub").on("click", function () {
					...
					$fn.confirm({msg : $fn.getCodeMsg("작성 하시겠습니까?")}).done( function() {
						if($("#sangid").val() != ""){							
                         ...
                         var _url = "/dwp/com/work/wonunit_master_1.nsf/wFrm01J?openform&masterid="+$("input[name=masterid]").val();
				 ...
				 $("#_pass").on("click", function () {
     				...
     				$fn.confirm({msg : $fn.getCodeMsg("작성 하시겠습니까?")}).done( function() {
						...
						//마스터에서 생산 작성시 마스터에 저장한 생산정보를 물류(생산) 양식에 저장하여 뷰에 보이도록 하기 위함
                         var _url = "/dwp/com/work/wonunit_master_1.nsf/wFrm05J?openform&masterid="+$("input[name=masterid]").val()+
				...
				//원가생산(자재)
				 ...
				 $("#_reject").on("click", function () {
					...
					$fn.confirm({msg : $fn.getCodeMsg("작성 하시겠습니까?")}).done( function() {
						...
						//마스터에서 생산 작성시 마스터에 저장한 생산정보를 물류(생산) 양식에 저장하여 뷰에 보이도록 하기 위함
                         var _url = "/dwp/com/work/wonunit_master_1.nsf/wFrm06J?openform&masterid="+$("input[name=masterid]").val()+
									"&kind="+$("input[name=kind]").val()+
									 "&processman="+$("input[name=processman]").val()+
									 "&sNo="+$("input[name=sNo]").val()+
									 "&sFumNo="+$("input[name=sFumNo]").val()+
                ...
                //생산검증
				 ...
				 $("#_bun").on("click", function () {
					...
					$fn.confirm({msg : $fn.getCodeMsg("작성 하시겠습니까?")}).done( function() {
						...
						//마스터에서 생산 작성시 마스터에 저장한 생산정보를 물류(생산) 양식에 저장하여 뷰에 보이도록 하기 위함
                         var _url = "/dwp/com/work/wonunit_master_1.nsf/wFrm07J?openform&masterid="+$("input[name=masterid]").val()+
									"&kind="+$("input[name=kind]").val()+
									 "&processman="+$("input[name=processman]").val()+
									 "&sNo="+$("input[name=sNo]").val()+
									 "&sFumNo="+$("input[name=sFumNo]").val()+
				 ...
				 $("#_bunc").on("click", function () {
					...
					$fn.confirm({msg : $fn.getCodeMsg("작성 하시겠습니까?")}).done( function() {
						...
						//마스터에서 생산 작성시 마스터에 저장한 생산정보를 물류(생산) 양식에 저장하여 뷰에 보이도록 하기 위함
                         var _url = "/dwp/com/work/wonunit_master_1.nsf/wFrm08J?openform&masterid="+$("input[name=masterid]").val()+
									"&kind="+$("input[name=kind]").val()+
									 "&processman="+$("input[name=processman]").val()+
									 "&sNo="+$("input[name=sNo]").val()+
									 "&sFumNo="+$("input[name=sFumNo]").val()+
                ...
                $("#_popgumae").on("click", function () {
                        ...
                        var _url = "/dwp/com/work/wonunit_master_1.nsf/vdockey/"+$("input[name=sangid]").val()+"?opendocument";
                ...
                $("#_popgumae6").on("click", function () {
                        ...
                        var _url = "/dwp/com/work/wonunit_master_1.nsf/vdockey/"+$("input[name=wonid]").val()+"?opendocument";
                ...
                $("#_popgumae4").on("click", function () {
                        ...
                        var _url = "/dwp/com/work/wonunit_master_1.nsf/vdockey/"+$("input[name=sangjaid]").val()+"?opendocument";
                    ...
                    $("#_popgumae5").on("click", function () {
                        ...
                        var _url = "/dwp/com/work/wonunit_master_1.nsf/vdockey/"+$("input[name=finalsangid]").val()+"?opendocument";
                    ...
                    $("#_popgumae7").on("click", function () {
                        ...
                        var _url = "/dwp/com/work/wonunit_master_1.nsf/vdockey/"+$("input[name=finalagreeid]").val()+"?opendocument";
            ...
            _initOptions: function (opt) {
                ...
                _opt.button = {
                    ...
                    goback: {
						...
						$fn.confirm({
							 ...
							 msg: $fn.getCodeMsg("구매(현조) 부분완료 하시겠습니까?완료시 수정불가능합니다")

						 }).done(function () {

                            $fn.cmdPost(
									$dwp.core.util.getProxyUrl('/dwp/com/work/wonunit_master_1.nsf/wcmdrefresh2?createdocument')
									,{actiontype : ('fs'), dbpath : '/dwp/com/work/wonunit_master_1.nsf' , postdata : $("#masterid1").val(), postdata1 : $("#vorgid").val()
								...
								if ( data.hasOwnProperty("result")) {
									...
									if ( data.result == "200") {
										var _url = "/dwp/com/work/wonunit_master_1.nsf/vdockey/"+$("input[name=masterid1]").val()+"?opendocument";
												$fn.loadPage({
              ...
              $fn.confirm({
                  ...
                  $fn.cmdPost(
                          $dwp.core.util.getProxyUrl('/dwp/com/work/wonunit_master_1.nsf/wcmdrefresh2?createdocument')
                          ,{actiontype : ('fs4'), dbpath : '/dwp/com/work/wonunit_master_1.nsf' , postdata : $("#masterid1").val(), postdata1 : $("#vorgid").val()
            ...
            $fn.confirm({
                ...
                $fn.cmdPost(
                        $dwp.core.util.getProxyUrl('/dwp/com/work/wonunit_master_1.nsf/wcmdrefresh2?createdocument')
                        ,{actiontype : ('fs5'), dbpath : '/dwp/com/work/wonunit_master_1.nsf' , postdata : $("#masterid1").val(), postdata1 : $("#vorgid").val()
		...
		fssavedoc6: {
            ...
            $fn.confirm({
                ...
                $fn.cmdPost(
                        $dwp.core.util.getProxyUrl('/dwp/com/work/wonunit_master_1.nsf/wcmdrefresh2?createdocument')
                        ,{actiontype : ('fs6'), dbpath : '/dwp/com/work/wonunit_master_1.nsf' , postdata : $("#masterid1").val(), postdata1 : $("#vorgid").val()
                        , sendflag : $("#mailsendflag").val()
                         }								
		...
		fssavedoc7: {
            ...
            $fn.confirm({
                ...
                $fn.cmdPost(
                        $dwp.core.util.getProxyUrl('/dwp/com/work/wonunit_master_1.nsf/wcmdrefresh2?createdocument')
                        ,{actiontype : ('fs7'), dbpath : '/dwp/com/work/wonunit_master_1.nsf' , postdata : $("#masterid1").val(), postdata1 : $("#vorgid").val()
                    ...
                    if ( data.hasOwnProperty("result")) {
                      ...
                      view_master: {
                        title: "마스터문서보기", 
                        click: function (view) {  
                          // /dwp/com/work/wonunit_master_1.nsf/vdockey/"+$("#sangid").val()+"?opendocument?opendocument
						var _url = "/dwp/com/work/wonunit_master_1.nsf/vdockey/"+$("input[name=masterid1]").val()+"?opendocument";
                        ...
                        click: function (view) {  
                          ...
                          $fn.confirm({
                            ...
                            var _Dailog = $fn.dialog(null, {
                                    ...
                                    content: {
                                       url: $fn.getProxyUrl("/dwp/com/work/wonunit_master_1.nsf" + '/' + _form + '?OpenForm')
                                    },
                                    open: function () {
                            ...
                            var _rows = view.getChecked();
                                ...
                                if (_rows.length == 0) {
                                     ...
                                     $fn.confirm({
                                        ...
                                        var _url = "/dwp/com/work/wonunit_master_1.nsf/wexceldown_tradeplace?OpenAgent";
									...
									,function(data){
										...
										if ( data.hasOwnProperty("result")) {
											...
											if ( data.result == "200") {
												    ...
												    var _url = "/dwp/com/work/wonunit_master_1.nsf/wexceldown_11?OpenAgent"+ "&unid=" + data.unid;
            ...
            _headerInfo: function (_opt) {
                ...
                _col = {
                    ...
                    location1: {
                        ...
                        title: $fn.getCodeMsg('pamt_wonunit_1.title.h1'), //사업장
                    ...
                    kind: {
                        ...
                        title: $fn.getCodeMsg('pamt_wonunit_1.title.h2'), //구분
                    ...
                    pkind: {
                        ...
                        title: $fn.getCodeMsg("pamt_wonunit_1.title.h2"),

                        click: function (view, data, ele) {



                            _$$.pamt_wonunit_1.view._poptrclickcustom(view, data, ele);
                    ...
                    code: {
                        ...
                        title: $fn.getCodeMsg('pamt_wonunit_1.title.h3'), //업체코드
                    ...
                    pcode: {
                        ...
                        title: $fn.getCodeMsg("pamt_wonunit_1.title.h3"),
                    ...
                    companyproto: {
                        ...
                        title: $fn.getCodeMsg('pamt_wonunit_1.title.h4'), //업체구분명
                    ...
                    pcompanyproto: {
                        ...
                        title: $fn.getCodeMsg("pamt_wonunit_1.title.h4"),
                    ...
                    servone: {
                        ...
                        title: $fn.getCodeMsg('pamt_wonunit_1.title.h5'), //서브원등록여부
                    ...
                    usernum: {
                        ...
                        title: $fn.getCodeMsg('pamt_wonunit_1.title.h13'), //사업자등록번호
                    ...
                    pusernum: {
                        ...
                        title: $fn.getCodeMsg("pamt_wonunit_1.title.h13"),
                    ...
                    value: {
                        ...
                        title: $fn.getCodeMsg('pamt_wonunit_1.title.h6'), //업체명
                    ...
                    pvalue: {
                        ...
                        title: $fn.getCodeMsg("pamt_wonunit_1.title.h6"),
                    ...
                    commaster: {
                        ...
                        title: $fn.getCodeMsg('pamt_wonunit_1.title.h7'), //대표이사
                    ...
                    pcommaster: {
                        ...
                        title: $fn.getCodeMsg("pamt_wonunit_1.title.h7"),
                    ...
                    telmaster: {
                        ...
                        title: $fn.getCodeMsg('pamt_wonunit_1.title.h8'), //대표이사 전화번호
                    ...
                    commanager: {
                        ...
                        title: $fn.getCodeMsg('pamt_wonunit_1.title.h9'), //담당자
                    ...
                    telmanager: {
                        ...
                        title: $fn.getCodeMsg('pamt_wonunit_1.title.h10'), //담당자 전화번호
                    ...
                    mailaddress: {
                        ...
                        title: $fn.getCodeMsg('pamt_wonunit_1.title.h11'), //담당자 전화번호
                    ...
                    authorname: {
                        ...
                        title: $fn.getCodeMsg('pamt_wonunit_1.title.h9'), //담당
