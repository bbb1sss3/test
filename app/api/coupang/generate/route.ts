...
- "자주 묻는 질문": Q&A 2개. "**Q. 질문내용**" 다음에 빈 줄을 넣고 그 다음 줄에 답변 2-3문장 (Q와 답변을 같은 줄에 붙이지 말 것)
...

{
  ...
  "hanmadi": "에디터의 솔직한 한마디. 친근한 ~요체. 실사용 경험을 암시하는 구체적 디테일 1개 포함. 2문장. 시작 표현을 매번 다르게 - '~써보니', '~동안 써본 결과', '처음엔 ~했는데', '주변에서 물어보면', '한 가지만 말하면', '솔직히' 등 다양하게 활용해 반복 패턴 피할 것",
